...
#define MAXLEN 500
#define SERVER_IP "107.21.132.128"
/**
...
int main(int argc, char **argv) {
    ...
    if(sockfd < 0) {
        printf("socketul nu a fost creat\n" );
        exit(-1);
    }
    ...
    sprintf(sendbuf, "MAIL FROM: <irinagrigore@mail.com>");
    send_command(sockfd, sendbuf, "250");
    ...
    sprintf(sendbuf, "MIME-Version: 1.0" "\r\n"
                        "From: irinagrigore@mail.com" "\r\n"
                        "To: gigel@mail.com" "\r\n"
                        "Subject: Mail" "\r\n"
                        "Content-Type: multipart/mixed; boundary=irina""\r\n""\r\n"
                        "--irina""\r\n"
